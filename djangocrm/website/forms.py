...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["username"].help_text = (
            '<span class="form-text text-muted"><small>Required. 50 characters or fewer. Letters, digits and @/./+/-/_ only.</small></span>'
        )
        ...
        self.fields["password2"].help_text = (
            '<span class="form-text text-muted"><small>Please Re-enter password, for verification.</small></span>'
        )
